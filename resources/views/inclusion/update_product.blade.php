...
<div id="updateModal" class="modal fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    ...
    <form class="mt-6" hx-put="/api/update/{{$product->id}}"
            ...
            <div class="m-2">
                ...
                <button type="button" onclick="closeModal()" class="bg-red-500 text-white font-bold py-2 px-4 rounded hover:bg-red-700 transition duration-300">Cancel</button>            </div>
            </form>
        </div>
    </div>
